...
An instumentation result of a trivial RTIC application are presented and graphically plotted to exemplify the value of the toolset, and topics of future work to improve the toolset are outlined.
#+end_abstract
#+begin_export latex
