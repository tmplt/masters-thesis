...
RTIC supports the ARM Cortex-M4 family of microprocessor core units (MCUs) which, in turn, offer asynchronous debug facilites for real-time tracing support [[parencite:&arm-rm C]].
Of chief interest are
- DWT, :: Data Watchpoint and Trace [[parencite:&arm-rm C1.8]]: contains program counter and address comparators that signal on a match; and
- ITM, :: Intrumentation Trace Macrocell [[parencite:&arm-rm C1.7]]: trace information generator in the form of packets; multiplexes trace information from other sources (e.g. DWT).
...
ITM is realized in practise by communicating between the embedded system and the analysing system with a packet protocol. [[parencite:&arm-rm D4]]
...
*** TODO 1: Trace stream exfiltration from target
...
*** TODO 2: Reading the trace stream from the source
# TODO serial and probe source
# TODO probe-rs
# TODO POSIX-compliance?

*** TODO 3: Decoding the ITM packet stream
...
*** TODO 4: Associating trace packets with RTIC task events
# TODO build_event_chunk

*** TODO 5: Forwarding resolved trace stream to sinks
# TODO
