...
~cortex-m-rtic-trace~ is an auxilliary target-side crate that configures all relevant Cortex-M peripherals --- namely the \gls{DCB}, \gls{TPIU}, \gls{DWT}, and \gls{ITM} --- for tracing.
