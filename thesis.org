...
It could present a real-time graphical representation of the system alike a ..., it could store the resolved trace in a database, or it could simply echo the messages to =stderr=.
