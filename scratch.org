...
*** TODO Investigate if dispatchers can be found from software tasks
...
*** TODO Investigate how watchpoints can be used for exact software tracing
...
**** TODO Configure a DWT comparator for data value tracing
...
**** TODO Specify the address to watch by some private RTIC "global"
     ...
     when writind the serialized values.

**** TODO Serialize software task ids to u32
...
**** TODO Specify DWT unit via RTIC app
     I.e. =#[app(device = ..., peripherals = true, dispatchers = [...],
     scope_dwt = DWT0)]=.
     The DWT unit chosen must be one of ~DWT_FUNCTION{0,1,2,3}~

**** TODO Specify if we want to trace via RTIC
