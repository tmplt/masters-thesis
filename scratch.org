...
** TODO Create some cargo-rtic-trace subcommand
...
*** TODO Save trace to disk for post-mortem
...
trace unless encoding is implemented in itm-decode.

**** TODO find the build cache
...
** TODO Find out when the tools fail
What happens when bandwidth is exhausted? Overflow? Halt?

** TODO itm-decode: export to figure displaying the task trace graphically
...
** TODO Create an RFC for embedded HAL to enable tracing
