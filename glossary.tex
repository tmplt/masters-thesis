...
\newglossaryentry{sigint}{
  name={SIGINT handler},
  description={A \gls{function} that executes when the program receives a SIGINT signal. SIGINT is the ``interrupt'' signal; on reception the program should terminate.}
}
